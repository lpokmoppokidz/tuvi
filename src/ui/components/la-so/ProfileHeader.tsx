...
import { slideUp, tapScale } from "../../utils/motion-config";
    ...
    <div className="flex items-center gap-4">
      ...
      <div>
        <h2 className="text-xl font-display text-gradient-gold tracking-wider">
          {tuViData?.thong_tin_co_ban?.ho_ten || "KHÁCH NHÂN"}
        </h2>
        <div className="flex items-center gap-2 mt-1">
          ...
          <p className="text-[9px] font-display text-white/40 tracking-[0.2em] uppercase">
            {tuViData?.thong_tin_co_ban?.can_chi_nam || "Vô Danh"} •{" "}
            {tuViData?.thong_tin_co_ban?.ngu_hanh_menh_cuc || "Tinh Tú"}
          </p>
        </div>
      </div>
    </div>
